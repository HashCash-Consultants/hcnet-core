...
This section describes how to configure the quorum set for a validator and assumes basic understanding of the [HcNet Consensus Protocol](https://www.HcNet.org/developers/guides/concepts/scp.html).
