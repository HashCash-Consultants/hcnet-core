...
# Integration points
## Data consumers
Many types of services can be built based on the data generated by HcNet-core.

HcNet-core generates two types of data that can be queried by applications.
 ...
 * additional meta data not available in history is produced by HcNet-core.
 ...
 * does not depend on running HcNet-core (can be built as a pure client
...
## API to HcNet-core
  HcNet-core exposes a simple HTTP based API for performing various
  types of operations on HcNet-core itself or on entities in the network
